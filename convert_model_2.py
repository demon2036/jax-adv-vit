...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained-model", type=str,
                        default='checkpoint/jax_model/best/cifar10/vit-l2-32-cifar10-6000ep-ls0.4-gap-beta3-ema.msgpack')
    parser.add_argument("--checkpoint", type=str,
                        default='checkpoint/pytorch_model/best/cifar10/vit-l2-32-cifar10-6000ep-ls0.4-gap-beta3-ema.pth')
