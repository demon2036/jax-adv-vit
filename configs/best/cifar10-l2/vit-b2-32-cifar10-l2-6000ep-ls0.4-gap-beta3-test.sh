export EPOCH=6000 TRAIN_BATCH_SIZE=64 WARMUP_EPOCH=5
...
python  -u hw.py \
    ...
    --beta 3.0 \
    --label-smoothing 0.4 \
#    --pretrained-ckpt  "gs://caster-us-central-2b-2/best/cifar10-l2/vit-b2-32-cifar10-l2-6000ep-ls0.4-gap-beta3-test-ema"